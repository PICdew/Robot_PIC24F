...
${OBJECTDIR}/sonar_hcsr04.o: sonar_hcsr04.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/sonar_hcsr04.o.d 
	@${RM} ${OBJECTDIR}/sonar_hcsr04.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  sonar_hcsr04.c  -o ${OBJECTDIR}/sonar_hcsr04.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/sonar_hcsr04.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/sonar_hcsr04.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/cn_intr.o: cn_intr.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/cn_intr.o.d 
	@${RM} ${OBJECTDIR}/cn_intr.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  cn_intr.c  -o ${OBJECTDIR}/cn_intr.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/cn_intr.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/cn_intr.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/moter_l298n.o: moter_l298n.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/moter_l298n.o.d 
	@${RM} ${OBJECTDIR}/moter_l298n.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  moter_l298n.c  -o ${OBJECTDIR}/moter_l298n.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/moter_l298n.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/moter_l298n.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/pwm_func.o: pwm_func.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/pwm_func.o.d 
	@${RM} ${OBJECTDIR}/pwm_func.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  pwm_func.c  -o ${OBJECTDIR}/pwm_func.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/pwm_func.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/pwm_func.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/kalman.o: kalman.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/kalman.o.d 
	@${RM} ${OBJECTDIR}/kalman.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  kalman.c  -o ${OBJECTDIR}/kalman.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/kalman.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/kalman.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/gyro_car.o: gyro_car.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/gyro_car.o.d 
...
${OBJECTDIR}/balance_car.o: balance_car.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/balance_car.o.d 
	@${RM} ${OBJECTDIR}/balance_car.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  balance_car.c  -o ${OBJECTDIR}/balance_car.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/balance_car.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/balance_car.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/sonar_hcsr04.o: sonar_hcsr04.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/sonar_hcsr04.o.d 
	@${RM} ${OBJECTDIR}/sonar_hcsr04.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  sonar_hcsr04.c  -o ${OBJECTDIR}/sonar_hcsr04.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/sonar_hcsr04.o.d"      -g -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/sonar_hcsr04.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/cn_intr.o: cn_intr.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/cn_intr.o.d 
	@${RM} ${OBJECTDIR}/cn_intr.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  cn_intr.c  -o ${OBJECTDIR}/cn_intr.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/cn_intr.o.d"      -g -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/cn_intr.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/moter_l298n.o: moter_l298n.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/moter_l298n.o.d 
	@${RM} ${OBJECTDIR}/moter_l298n.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  moter_l298n.c  -o ${OBJECTDIR}/moter_l298n.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/moter_l298n.o.d"      -g -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/moter_l298n.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/pwm_func.o: pwm_func.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/pwm_func.o.d 
	@${RM} ${OBJECTDIR}/pwm_func.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  pwm_func.c  -o ${OBJECTDIR}/pwm_func.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/pwm_func.o.d"      -g -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/pwm_func.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/kalman.o: kalman.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/kalman.o.d 
	@${RM} ${OBJECTDIR}/kalman.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  kalman.c  -o ${OBJECTDIR}/kalman.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/kalman.o.d"      -g -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/kalman.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/balance_car.o: balance_car.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/balance_car.o.d 
	@${RM} ${OBJECTDIR}/balance_car.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  balance_car.c  -o ${OBJECTDIR}/balance_car.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/balance_car.o.d"      -g -omf=elf -ffunction-sections -fdata-sections -mlarge-data -O0 -I"FreeRTOS/Source/include" -I"." -DMPLAB_PIC24_PORT -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/balance_car.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Robot_PIC24F.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Robot_PIC24F.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--heap=1024,--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--cref,--warn-section-align$(MP_EXTRA_LD_POST) 
